...
public class ProductServiceImpl implements ProductService {
    ...
    @org.springframework.cache.annotation.Cacheable(value = "product-details", key = "#productId")
    ...
    // Add updateProduct method with cache eviction
    @org.springframework.cache.annotation.CacheEvict(value = "product-details", key = "#productDTO.id")
